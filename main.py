...
args = dotdict({
    ...
    'num_mcts_sims': 25,            # Number of moves for MCTS to improve the network estimation.
    'arena_matches': 10,            # Number of games to play during arena play to determine.
    'cpuct': 1,

    'checkpoint': './nonaga/models',
    'load_model': False,
    'load_folder_file': ('./nonaga/models/', 'best.h5', 'checkpoint_samples_12.pth.tar'),
