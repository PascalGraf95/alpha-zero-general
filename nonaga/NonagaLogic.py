...
class Game:
    ...
    def __init__(self, scenario=0):
        ...
        # Player 1 needs to do the right move prevent player -1 from winning
            ...
            self.board[0][7][3] = self.board[0][6][2] = self.board[0][8][4] = 1
            self.board[0][8][2] = self.board[0][7][1] = self.board[0][9][3] = 1
            self.board[0][9][1] = self.board[0][8][0] = self.board[0][10][2] = 1
            self.board[0][10][0] = self.board[0][11][1] = 1
